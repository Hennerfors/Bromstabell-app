...
# STEG 1: DIGITALISERAD DATA FRÅN DINA PDF-TABELLER
# ----------------------------------------------------
# Datastruktur:
# {
#   'Bana': {
...
HASTIGHETS_DATA = {
    ...
    'EM': {
        (0, 400): [  # Gäller för intervallen -100, 101-200, 201-300, 301-400
...
# OBS: Ovanstående data är en förkortad version för att hålla koden läsbar.
# En fullständig applikation skulle ha all data från alla tabeller inmatad.
...
# Knapp och resultat
if st.button('Hitta högsta tillåtna hastighet'):
    resultat = hitta_max_hastighet(bana_vald, tåglängd_inmatad, bromsprocent_inmatad)
